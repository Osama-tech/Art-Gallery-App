...
import { View, TouchableOpacity, TextInput, NativeSyntheticEvent, TextInputKeyPressEventData } from 'react-native';
...
const Form = () => {
	...
	const onSignUpPress = async () => {
		...
		try {
			...
			console.log("Preparing email verification for:", email);
	...
	const onPressVerify = async () => {
		...
		try {
			console.log("Attempting email verification for code:", code.join(''));
